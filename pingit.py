...
def ping_router(hostname):
    ...
    if response == 0:
        ...
        return False
def parsestff(options):
    parser = argparse.ArgumentParser(description='switch Ip addresses.')
    parser.add_argument('ip', help=first ip address)
    parser.add_argument('ip2', help=second ip address)
